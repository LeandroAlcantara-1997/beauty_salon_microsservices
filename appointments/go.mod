module github.com/LeandroAlcantara-1997/appointment

go 1.17

require github.com/facily-tech/go-core/log v0.2.1
...
require (
	...
	github.com/facily-tech/go-core/telemetry v0.5.0 // indirect
